  ...
  return (
    <AudioResultWrapper>
      ...
      <div>
        ...
        :<a href={'/static/text/' + userId + '__1.txt'} download>Download</a>
        }
      ...
      <div>
        ...
        :<a href={'/static/text/' + userId + '__2.txt'} download>Download</a>
        }
      </div>
      {count > 2 && <div>
        ...
        :<a href={'/static/text/' + userId + '__3.txt'} download>Download</a>
        }
      </div> }
      {count > 3 && <div>
        ...
        :<a href={'/static/text/' + userId + '__4.txt'} download>Download</a>
        }
      </div>}
    </AudioResultWrapper>
  )
